...
const Admin_TeacherManagement = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: 'avatar',
            key: 'avatar',
            render: (text) => <img className='admin-teacher-management-icon' src={text}/>,
        },
        {
            title: '用户名',
            dataIndex: 'username',
    ...
    const search = () => {
        ...
        userRequest.post("/admin/get-teacher", {
            searchStr: searchStr
        })
    ...
    const handleOk = () => {
        ...
        if(newAvatar == ""){
            ...
            userRequest.post("/admin/update-teacher-info", {
                curUserId: curUserId,
                newAvatar: newAvatar,
            ...
            .then(function(response) {
                console.log(response)
                if(response.resultCode == 12060){
                    message.success(response.msg)
                }
                else if(response.resultCode == 12061){
    ...
    return(
        <div>
            ...
            <div className="admin-teacher-management-div">

                <div className='admin-teacher-management-filter-outer-div'>
                    <div className='admin-teacher-management-filter-inner-div'>
                        <label>真名：</label>
                        <Input className='admin-teacher-management-search-input' onChange={changeSearchStr}></Input>
                    </div>
                    
                    <Button type='primary' onClick={search} className='admin-teacher-management-search-button'>搜索</Button>
                </div>

                <Table className='admin-teacher-management-table' dataSource={teacherList} columns={columns} />
...
export default Admin_TeacherManagement